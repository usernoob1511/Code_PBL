...
Item {
    ...
    states: [
        State {
            ...
            PropertyChanges { target: dayOfWeek; enabled: false }
        ...
        State {
            ...
            PropertyChanges { target: dayOfWeek; enabled: true }
        }
    ]
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Button {
                ...
                onClicked: {
                    if (rootViewandEditDoctor.state === "editDoctor") {
                ...
                Dialog {
                    ...
                    width: 400
                    height: 200
                    x: 414 + (rootViewandEditDoctor.width - width)/2
                    y: (rootViewandEditDoctor.height - height)/2
