...
Item {
    id: rootViewandEditOutpatient
    width: 1500
    height: 1080

    property int check_OutpatientId: 1
    ...
    Button {
        ...
        Dialog {
            ...
            width: 400
            height: 200
            x: 414 + (rootViewandEditOutpatient.width - width)/2
            y: (rootViewandEditOutpatient.height - height)/2
