...
Item {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            TextField {
                ...
                width: 308
                height: 41
                placeholderText:  rootaddPatient.state === "addInpatient" ? qsTr("I0001") : qsTr("O1001")
                font.pointSize: 14
                font.italic: false
                font.family: "Times New Roman"
                verticalAlignment: Text.AlignVCenter
                ...
                validator: RegularExpressionValidator {
                    regularExpression: rootaddPatient.state === "addInpatient" ? /^[I][0-9]{0,4}$/ : /^[O][0-9]{0,4}$/
                }

                onEditingFinished: {
                    if (rootaddPatient.state === "addInpatient") {
    ...
    Button {
        ...
        Dialog {
            ...
            width: 400
            height: 200
            x: 414 + (rootaddPatient.width - width)/2
            y: (rootaddPatient.height - height)/2
