...
Item {
    ...
    //     onClicked:{
    //         if( root.name_str !== ""){
    //             root.name_str = addressBookData.name //take name of contact person
    //             root.mobile_str = addressBookData.mobile
    //             root.address_str = addressBookData.address

    //             console.log("mainBody.name_str ===> "+root.name_str)
    //             confirmationDialog.open()
    //         }
    //         else
    //             messageDialog.open()
    ...
    //         onAccepted: {
    //             console.log("yes")
    //             addressBookData.getRowIdDb(root.id_str) //get record id in db
    //             addressBookData.removeItems()
    //             root.myrow = -1
    //             root.myrowcount--;
    //             root.name_str = ""
    //             root.mobile_str = ""
